...
<html lang="en">
  ...
  <header class="header">
    ...
    <section class="hero">
        ...
        <p>Hi, <b><?php echo htmlspecialchars($_SESSION['username']); ?></b>, welcome back! Visit your <a href='user_profile.php'>profile</a>.</p> <!--Visit your <a href='user_profile.php'>profile</a>."; -->
        <div class="container">
      <div class="">
        <div class="searchbar">
